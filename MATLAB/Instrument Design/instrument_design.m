...
%ripped violin from GM midi library - predefined
%ripped violin from GM midi library - predefined
...
sound(C5,fs);pause(1);sound(D5,fs);pause(1);sound(E5,fs);pause(1);
sound(F5,fs);pause(1);sound(G5,fs);pause(1);sound(A5,fs);pause(1);
sound(G5,fs);pause(1);sound(A5,fs);pause(1);sound(B5,fs);pause(1);
sound(C5,fs);
pause(5)
sound(C6,fs);pause(1);sound(C6,fs);pause(1);sound(G5,fs);pause(1);
sound(G5,fs);pause(1);sound(A4,fs);pause(1);sound(A4,fs);pause(1);
sound(G5,fs);pause(1);sound(F5,fs);pause(1);sound(F5,fs);pause(1);
sound(E5,fs);pause(1);sound(E5,fs);pause(1);sound(D5,fs);pause(1);
sound(D5,fs);pause(1);sound(C5,fs);pause(1);
pause(1);
sound(C5,fs);pause(1);sound(C5,fs);pause(1);sound(G5,fs);pause(1);
sound(G5,fs);pause(1);sound(A5,fs);pause(1);sound(A5,fs);pause(1);
sound(G5,fs);pause(1);sound(F5,fs);pause(1);sound(F5,fs);pause(1);
sound(E5,fs);pause(1);sound(E5,fs);pause(1);sound(D5,fs);pause(1);
sound(D5,fs);pause(1);sound(C5,fs);pause(1);
pause(1);
sound(G5,fs);pause(1);sound(G5,fs);pause(1);sound(F5,fs);pause(1);
sound(F5,fs);pause(1);sound(E5,fs);pause(1);sound(E5,fs);pause(1);
sound(D5,fs);pause(1);
pause(1);
sound(G5,fs);pause(1);sound(G5,fs);pause(1);sound(F5,fs);pause(1);
sound(F5,fs);pause(1);sound(E5,fs);pause(1);sound(E5,fs);pause(1);
...
%sound([C5 C5 C5 G5 A5 A5 A5 E5],fs)
