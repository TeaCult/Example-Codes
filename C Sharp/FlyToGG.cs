...
//
//
// This document has beren edited to change flying behaviour of honorbuddy Bot AI by G.G.
    ...
    class FlyTo : CustomForcedBehavior
    {
        ...
        public override void OnStart()
		{
            ...
            if (!IsDone)
            {
                ...
                CharacterSettings.Instance.HarvestHerbs = true;
                CharacterSettings.Instance.HarvestMinerals = true;
